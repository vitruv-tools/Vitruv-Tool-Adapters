...
package tools.vitruv.views.emf.monitorededitor.monitor;
...
import tools.vitruv.views.emf.monitorededitor.IEditorPartAdapterFactory;
import tools.vitruv.views.emf.monitorededitor.ISynchronizingMonitoredEmfEditor;
import tools.vitruv.views.emf.monitorededitor.IEditorPartAdapterFactory.IEditorPartAdapter;
import tools.vitruv.views.emf.monitorededitor.IVitruviusEMFEditorMonitor.IVitruviusAccessor;
import tools.vitruv.views.emf.monitorededitor.test.mocking.EclipseMock;
import tools.vitruv.views.emf.monitorededitor.test.mocking.EclipseMock.SaveEventKind;
import tools.vitruv.views.emf.monitorededitor.test.testmodels.Files;
import tools.vitruv.views.emf.monitorededitor.test.utils.BasicTestCase;
import tools.vitruv.views.emf.monitorededitor.test.utils.ChangeAssert;
import tools.vitruv.views.emf.monitorededitor.test.utils.DefaultImplementations;
import tools.vitruv.views.emf.monitorededitor.test.utils.EnsureExecuted;
import tools.vitruv.views.emf.monitorededitor.test.utils.DefaultImplementations.TestVirtualModel;
import tools.vitruv.views.emf.monitorededitor.tools.EclipseAdapterProvider;
import tools.vitruv.views.emf.monitorededitor.tools.IEclipseAdapter;
