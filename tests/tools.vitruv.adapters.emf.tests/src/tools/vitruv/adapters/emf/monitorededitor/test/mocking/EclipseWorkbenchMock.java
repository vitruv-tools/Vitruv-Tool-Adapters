...
package tools.vitruv.adapters.emf.monitorededitor.test.mocking;
...
import tools.vitruv.adapters.emf.monitorededitor.test.mocking.EclipseMock.EditorPartMgmtEvent;
