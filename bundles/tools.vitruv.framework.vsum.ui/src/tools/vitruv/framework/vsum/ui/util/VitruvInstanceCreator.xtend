...
class VitruvInstanceCreator {
	...
	val Map<IProject, ? extends Set<VitruvEclipseProjectBuilderApplicator>> projectToApplicators
	val Iterable<VitruvApplication> applications
	val String name

	new(String name, Map<IProject, Set<VitruvEclipseProjectBuilderApplicator>> projectToApplicators, Iterable<VitruvApplication> applications) {
